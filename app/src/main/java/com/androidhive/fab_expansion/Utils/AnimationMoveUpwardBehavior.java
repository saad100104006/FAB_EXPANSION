package com.androidhive.fab_expansion.Utils;
...
public class AnimationMoveUpwardBehavior extends CoordinatorLayout.Behavior<View> {
    public AnimationMoveUpwardBehavior() {
        super();
    }

    public AnimationMoveUpwardBehavior(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
